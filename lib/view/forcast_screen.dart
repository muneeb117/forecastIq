...
class _ForcastScreenState extends State<ForcastScreen> {
  ...
  final List<Map<String, dynamic>> _allFavoritesItems = [
    {
      'image': AppImages.btc,
      'symbol': 'BTC',
      'name': 'Bitcoin',
                    ...
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: Padding(
                            padding: EdgeInsets.only(left: 20.w,right: 12.w), // Adjust icon padding
                            child: SvgPicture.asset(
                              AppImages.search,
                              width: 18.w,
                              height: 18.h,
                              color: AppColors.kwhite, // Ensure icon color matches text
                    ...
                    child: Container(
                      ...
                      child: Center(
                        child: SvgPicture.asset(
                          ...
                          width: 24.w,
                          height: 24.h,
                          color: AppColors.kwhite, // Match filter icon color
                          fit: BoxFit.contain,
                        ),
                      ),
                    ),
  ...
  Widget _buildStocksContent() {
    ...
    return Column(
      children: filteredItems.map((item) => Column(
        children: [
          buildTrendingItem(
            item['image'],
            item['symbol'],
  ...
  Widget _buildFavoritesContent() {
    List<Map<String, dynamic>> filteredItems = _filterItems(_allFavoritesItems);
